[![CI](https://github.com/akalinux/linked-bundle-node-map/actions/workflows/ci.yml/badge.svg)](https://github.com/akalinux/linked-bundle-node-map/actions/workflows/ci.yml)
